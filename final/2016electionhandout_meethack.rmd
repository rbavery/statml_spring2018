...
```{r data}
election.raw = read.csv("data/election/election.csv") %>% as_tibble
census_meta = read.csv("data/census/metadata.csv", sep = ";") %>% as_tibble
census = read.csv("data/census/census.csv") %>% as_tibble
...
election_county = filter(election.raw, !is.na(county), !is.na(fips))
```
