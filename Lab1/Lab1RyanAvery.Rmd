---
title: "Lab 1 Homework Assignment"
author: "Ryan Avery and Team Member2"
date: "`r format(Sys.Date(), '%B %d, %Y')`"
output: pdf_document
---

Probabilities should not exceed 1. $\theta$
include - controls if chunk is knitted
results - controls if return vals printed
echo - controls if code is shown
eval - controls if code is run
cache - speeds creation
